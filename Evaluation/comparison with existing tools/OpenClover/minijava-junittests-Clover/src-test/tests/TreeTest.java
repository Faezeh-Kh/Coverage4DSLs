...
//	@Test
//	public void test1_HasLeft_HasRight() {
//		Tree root = new Tree();
//		root.Init(10) ;
//		root.Insert(9) ;
//		root.Insert(11) ;
...
//
//	@Test
//	public void test2_HasLeft_HasRight() {
//		Tree root = new Tree();
//		root.Init(10) ;
//		root.Insert(9) ;
//		root.Insert(8) ;
...
//	
//	@Test
//	public void test3_HasLeft_HasRight() {
//		Tree root = new Tree();
//		root.Init(10) ;
//		root.Insert(11) ;
//		root.Insert(12) ;
...
////		root.Insert(12) ;
////		root.Insert(14) ;
////		assertEquals(true, root.Delete(10));//left leave
////		assertEquals(false, root.Search(10));
////	}
//	
//	@Test
...
////		root.Insert(10) ;
////		root.Insert(13) ;
////		root.Insert(14) ;//its parent doesn't have a left element
////		assertEquals(true, root.Delete(14));//right leave
////		assertEquals(false, root.Search(14));
////	}
//	
...
////		root.Insert(13) ;
////		root.Insert(12) ;
////		assertEquals(true, root.Delete(12));//right leave
////		assertEquals(false, root.Search(12));
////	}
//	
//	@Test
...
//	}
//	@Test
//	public void test20_Compare() {
//		assertEquals(true, tree.Compare(0, 0));
//	}
//	
//	@Test
//	public void test21_Compare() {
//		assertEquals(false, tree.Compare(1, 0));
//	}
//	
//	@Test
//	public void test22_Compare() {
//		assertEquals(false, tree.Compare(0, 1));
//	}
//	
//	@Test
//	public void test23_Compare() {
//		assertEquals(true, tree.Compare(1, 1));
//	}
//	
//	@Test
//	public void test24_Compare() {
//		assertEquals(false, tree.Compare(0, -1));
//	}
//	
//	@Test
//	public void test25_Compare() {
//		assertEquals(true, tree.Compare(-1, -1));
//	}
}

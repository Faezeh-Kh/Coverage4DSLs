We created a virtual machine using [Oracle VM VirtualBox](https://www.virtualbox.org/) and set it up for easy use of the tool provided in this repository.
You can access the virtual machine from [this Zenodo repository](https://zenodo.org/record/7178669).
Please note that the virtual machine already has the content of this repository (it is on the desktop in a folder named `Coverage4DSLs`).

...
public abstract class BluetoothTransceiver_PushAspect extends ArduinoCommunicationModule_PushAspect {
  ...
  public static void push(final BluetoothTransceiver _self) {
    final org.imt.arduino.reactive.interpreter.BluetoothTransceiver_PushAspectBluetoothTransceiverAspectProperties _self_ = org.imt.arduino.reactive.interpreter.BluetoothTransceiver_PushAspectBluetoothTransceiverAspectContext.getSelf(_self);
    ...
    if (_self instanceof org.imt.arduino.reactive.arduino.BluetoothTransceiver){
    	fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand command = new fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand() {
    		@Override
    		public void execute() {
    			org.imt.arduino.reactive.interpreter.BluetoothTransceiver_PushAspect._privk3_push(_self_, (org.imt.arduino.reactive.arduino.BluetoothTransceiver)_self);
    		}
    	};
  ...
  public static EList<Integer> dataToSend(final BluetoothTransceiver _self) {
    ...
    if (_self instanceof org.imt.arduino.reactive.arduino.BluetoothTransceiver){
    	result = org.imt.arduino.reactive.interpreter.BluetoothTransceiver_PushAspect._privk3_dataToSend(_self_, (org.imt.arduino.reactive.arduino.BluetoothTransceiver)_self);
    };
  ...
  public static void dataToSend(final BluetoothTransceiver _self, final EList<Integer> dataToSend) {
    ...
    if (_self instanceof org.imt.arduino.reactive.arduino.BluetoothTransceiver){
    	org.imt.arduino.reactive.interpreter.BluetoothTransceiver_PushAspect._privk3_dataToSend(_self_, (org.imt.arduino.reactive.arduino.BluetoothTransceiver)_self,dataToSend);
    };
  }
  ...
  public static EList<Integer> dataReceived(final BluetoothTransceiver _self) {
    ...
    if (_self instanceof org.imt.arduino.reactive.arduino.BluetoothTransceiver){
    	result = org.imt.arduino.reactive.interpreter.BluetoothTransceiver_PushAspect._privk3_dataReceived(_self_, (org.imt.arduino.reactive.arduino.BluetoothTransceiver)_self);
    };
    return (org.eclipse.emf.common.util.EList<java.lang.Integer>)result;
  }
  ...
  public static void dataReceived(final BluetoothTransceiver _self, final EList<Integer> dataReceived) {
    ...
    if (_self instanceof org.imt.arduino.reactive.arduino.BluetoothTransceiver){
    	org.imt.arduino.reactive.interpreter.BluetoothTransceiver_PushAspect._privk3_dataReceived(_self_, (org.imt.arduino.reactive.arduino.BluetoothTransceiver)_self,dataReceived);
    };
  }

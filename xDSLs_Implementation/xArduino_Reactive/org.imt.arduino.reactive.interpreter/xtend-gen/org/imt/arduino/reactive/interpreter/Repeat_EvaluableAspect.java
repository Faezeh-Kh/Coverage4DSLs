...
public class Repeat_EvaluableAspect extends Control_EvaluableAspect {
  ...
  public static Boolean evaluate(final Repeat _self) {
    final org.imt.arduino.reactive.interpreter.Repeat_EvaluableAspectRepeatAspectProperties _self_ = org.imt.arduino.reactive.interpreter.Repeat_EvaluableAspectRepeatAspectContext.getSelf(_self);
    Object result = null;
    // #DispatchPointCut_before# Boolean evaluate()
    if (_self instanceof org.imt.arduino.reactive.arduino.Repeat){
    	result = org.imt.arduino.reactive.interpreter.Repeat_EvaluableAspect._privk3_evaluate(_self_, (org.imt.arduino.reactive.arduino.Repeat)_self);
    };
  ...
  public static void finalize(final Repeat _self) {
    ...
    if (_self instanceof org.imt.arduino.reactive.arduino.Repeat){
    	org.imt.arduino.reactive.interpreter.Repeat_EvaluableAspect._privk3_finalize(_self_, (org.imt.arduino.reactive.arduino.Repeat)_self);
    };
  }
  ...
  private static Integer i(final Repeat _self) {
    ...
    if (_self instanceof org.imt.arduino.reactive.arduino.Repeat){
    	result = org.imt.arduino.reactive.interpreter.Repeat_EvaluableAspect._privk3_i(_self_, (org.imt.arduino.reactive.arduino.Repeat)_self);
    };
  ...
  private static void i(final Repeat _self, final Integer i) {
    ...
    if (_self instanceof org.imt.arduino.reactive.arduino.Repeat){
    	org.imt.arduino.reactive.interpreter.Repeat_EvaluableAspect._privk3_i(_self_, (org.imt.arduino.reactive.arduino.Repeat)_self,i);
    };
  }
  ...
  private static void super_finalize(final Repeat _self) {
    final org.imt.arduino.reactive.interpreter.Instruction_ExecutableAspectInstructionAspectProperties _self_ = org.imt.arduino.reactive.interpreter.Instruction_ExecutableAspectInstructionAspectContext.getSelf(_self);
     org.imt.arduino.reactive.interpreter.Instruction_ExecutableAspect._privk3_finalize(_self_, _self);
  }

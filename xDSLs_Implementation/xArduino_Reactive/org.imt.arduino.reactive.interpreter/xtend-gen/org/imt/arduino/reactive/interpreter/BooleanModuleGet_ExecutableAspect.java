...
public class BooleanModuleGet_ExecutableAspect extends Expression_EvaluableAspect {
  ...
  public static Object evaluate(final BooleanModuleGet _self) {
    final org.imt.arduino.reactive.interpreter.BooleanModuleGet_ExecutableAspectBooleanModuleGetAspectProperties _self_ = org.imt.arduino.reactive.interpreter.BooleanModuleGet_ExecutableAspectBooleanModuleGetAspectContext.getSelf(_self);
    Object result = null;
    ...
    if (_self instanceof org.imt.arduino.reactive.arduino.BooleanModuleGet){
    	fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand command = new fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand() {
    		@Override
    		public void execute() {
    			addToResult(org.imt.arduino.reactive.interpreter.BooleanModuleGet_ExecutableAspect._privk3_evaluate(_self_, (org.imt.arduino.reactive.arduino.BooleanModuleGet)_self));
    		}
    	};

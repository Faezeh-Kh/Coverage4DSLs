...
public class Pin_EvaluableAspectPinAspectContext {
  ...
  public static Pin_EvaluableAspectPinAspectProperties getSelf(final Pin _self) {
    		if (!INSTANCE.map.containsKey(_self))
    			INSTANCE.map.put(_self, new org.imt.arduino.reactive.interpreter.Pin_EvaluableAspectPinAspectProperties());
    		return INSTANCE.map.get(_self);
  }
  
  private Map<Pin, Pin_EvaluableAspectPinAspectProperties> map = new java.util.WeakHashMap<org.imt.arduino.reactive.arduino.Pin, org.imt.arduino.reactive.interpreter.Pin_EvaluableAspectPinAspectProperties>();

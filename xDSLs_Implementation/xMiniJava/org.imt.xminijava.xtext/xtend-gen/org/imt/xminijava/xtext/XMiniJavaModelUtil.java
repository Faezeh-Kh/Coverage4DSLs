...
public class XMiniJavaModelUtil {
  protected Iterable<Field> _fields(final org.imt.minijava.xminiJava.Class c) {
  ...
  public Set<TypeDeclaration> getSuperTypes(final TypeDeclaration c) {
    ...
    if ((c instanceof org.imt.minijava.xminiJava.Class)) {
      org.imt.minijava.xminiJava.Class _superClass = ((org.imt.minijava.xminiJava.Class)c).getSuperClass();
      boolean _tripleNotEquals = (_superClass != null);
      if (_tripleNotEquals) {
        current.add(((org.imt.minijava.xminiJava.Class)c).getSuperClass());
      }
    }
    current.addAll(c.getImplements());
    return current;
  }
  ...
  public Iterable<Field> fields(final TypeDeclaration c) {
    if (c instanceof org.imt.minijava.xminiJava.Class) {
      return _fields((org.imt.minijava.xminiJava.Class)c);

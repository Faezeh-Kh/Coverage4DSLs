...
public class InferiorAspect extends ExpressionAspect {
  ...
  public static Value evaluateExpression(final Inferior _self, final State state) {
    final org.imt.xminijava.interpreter.InferiorAspectInferiorAspectProperties _self_ = org.imt.xminijava.interpreter.InferiorAspectInferiorAspectContext.getSelf(_self);
    Object result = null;
    // #DispatchPointCut_before# Value evaluateExpression(State)
    if (_self instanceof org.imt.minijava.xminiJava.Inferior){
    	result = org.imt.xminijava.interpreter.InferiorAspect._privk3_evaluateExpression(_self_, (org.imt.minijava.xminiJava.Inferior)_self,state);
    };

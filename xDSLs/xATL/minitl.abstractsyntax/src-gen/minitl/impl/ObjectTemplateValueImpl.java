...
public class ObjectTemplateValueImpl extends ValueImpl implements ObjectTemplateValue {
			...
			if (objecttemplate != oldObjecttemplate) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							minitlPackage.OBJECT_TEMPLATE_VALUE__OBJECTTEMPLATE, oldObjecttemplate, objecttemplate));
			}
		}
	...
	public void setObjecttemplate(ObjectTemplate newObjecttemplate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, minitlPackage.OBJECT_TEMPLATE_VALUE__OBJECTTEMPLATE,
					oldObjecttemplate, objecttemplate));
	}

...
public class RuleImpl extends NamedElementImpl implements Rule {
	...
	public EList<ObjectTemplate> getObjectTemplates() {
		if (objectTemplates == null) {
			objectTemplates = new EObjectContainmentWithInverseEList<ObjectTemplate>(ObjectTemplate.class, this,
					minitlPackage.RULE__OBJECT_TEMPLATES, minitlPackage.OBJECT_TEMPLATE__RULE);
		}
	...
	public Transformation getTransformation() {
		if (eContainerFeatureID() != minitlPackage.RULE__TRANSFORMATION)
			return null;
	...
	public void setTransformation(Transformation newTransformation) {
		if (newTransformation != eInternalContainer()
				|| (eContainerFeatureID() != minitlPackage.RULE__TRANSFORMATION && newTransformation != null)) {
			...
			if (newTransformation != null)
				msgs = ((InternalEObject) newTransformation).eInverseAdd(this, minitlPackage.TRANSFORMATION__RULES,
						Transformation.class, msgs);
			msgs = basicSetTransformation(newTransformation, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, minitlPackage.RULE__TRANSFORMATION, newTransformation,
					newTransformation));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case minitlPackage.RULE__TRANSFORMATION:
			return eInternalContainer().eInverseRemove(this, minitlPackage.TRANSFORMATION__RULES, Transformation.class,
					msgs);
		}

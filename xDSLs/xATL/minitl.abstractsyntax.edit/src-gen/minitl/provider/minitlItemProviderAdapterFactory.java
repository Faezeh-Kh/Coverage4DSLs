 ...
 * @generated
 */
public class minitlItemProviderAdapterFactory extends minitlAdapterFactory
	...
	public void dispose() {
		...
		if (fieldAccessValueItemProvider != null)
			fieldAccessValueItemProvider.dispose();
		if (objectTemplateItemProvider != null)
			objectTemplateItemProvider.dispose();
		if (stringValueItemProvider != null)
			stringValueItemProvider.dispose();
		if (objectTemplateValueItemProvider != null)
			objectTemplateValueItemProvider.dispose();
		if (metamodelItemProvider != null)

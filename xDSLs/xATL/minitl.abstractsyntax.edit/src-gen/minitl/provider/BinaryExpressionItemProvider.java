...
public class BinaryExpressionItemProvider extends ValueItemProvider {
	...
	protected void addOperatorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_BinaryExpression_operator_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_BinaryExpression_operator_feature",
								"_UI_BinaryExpression_type"),
						minitlPackage.Literals.BINARY_EXPRESSION__OPERATOR, true, false, false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(minitlPackage.Literals.BINARY_EXPRESSION__EXPRESSIONS,

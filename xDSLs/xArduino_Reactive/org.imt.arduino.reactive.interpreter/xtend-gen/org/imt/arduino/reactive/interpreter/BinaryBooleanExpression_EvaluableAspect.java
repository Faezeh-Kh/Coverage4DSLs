...
import org.imt.arduino.reactive.arduino.BinaryBooleanOperatorKind;
...
public class BinaryBooleanExpression_EvaluableAspect extends Expression_EvaluableAspect {
  ...
  public static Object evaluate(final BinaryBooleanExpression _self) {
    final org.imt.arduino.reactive.interpreter.BinaryBooleanExpression_EvaluableAspectBinaryBooleanExpressionAspectProperties _self_ = org.imt.arduino.reactive.interpreter.BinaryBooleanExpression_EvaluableAspectBinaryBooleanExpressionAspectContext.getSelf(_self);
    Object result = null;
    // #DispatchPointCut_before# Object evaluate()
    if (_self instanceof org.imt.arduino.reactive.arduino.BinaryBooleanExpression){
    	result = org.imt.arduino.reactive.interpreter.BinaryBooleanExpression_EvaluableAspect._privk3_evaluate(_self_, (org.imt.arduino.reactive.arduino.BinaryBooleanExpression)_self);
    };

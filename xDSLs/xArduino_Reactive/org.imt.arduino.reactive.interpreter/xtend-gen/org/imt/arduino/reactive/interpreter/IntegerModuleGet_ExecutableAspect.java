...
public class IntegerModuleGet_ExecutableAspect extends Expression_EvaluableAspect {
  ...
  public static Object evaluate(final IntegerModuleGet _self) {
    final org.imt.arduino.reactive.interpreter.IntegerModuleGet_ExecutableAspectIntegerModuleGetAspectProperties _self_ = org.imt.arduino.reactive.interpreter.IntegerModuleGet_ExecutableAspectIntegerModuleGetAspectContext.getSelf(_self);
    Object result = null;
    ...
    if (_self instanceof org.imt.arduino.reactive.arduino.IntegerModuleGet){
    	fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand command = new fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand() {
    		@Override
    		public void execute() {
    			addToResult(org.imt.arduino.reactive.interpreter.IntegerModuleGet_ExecutableAspect._privk3_evaluate(_self_, (org.imt.arduino.reactive.arduino.IntegerModuleGet)_self));
    		}
    	};

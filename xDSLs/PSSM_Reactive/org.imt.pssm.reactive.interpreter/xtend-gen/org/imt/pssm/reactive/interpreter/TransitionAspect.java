...
public class TransitionAspect {
  ...
  public static void fire(final Transition _self, final EventOccurrence eventOccurrence) {
    final org.imt.pssm.reactive.interpreter.TransitionAspectTransitionAspectProperties _self_ = org.imt.pssm.reactive.interpreter.TransitionAspectTransitionAspectContext.getSelf(_self);
    // #DispatchPointCut_before# void fire(EventOccurrence)
    if (_self instanceof org.imt.pssm.reactive.model.statemachines.Transition){
    	fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand command = new fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand() {
    		@Override
    		public void execute() {
    			org.imt.pssm.reactive.interpreter.TransitionAspect._privk3_fire(_self_, (org.imt.pssm.reactive.model.statemachines.Transition)_self,eventOccurrence);
    		}
    	};
  ...
  protected static boolean canFireOn(final Transition _self, final EventOccurrence eventOccurrence) {
    ...
    if (_self instanceof org.imt.pssm.reactive.model.statemachines.Transition){
    	result = org.imt.pssm.reactive.interpreter.TransitionAspect._privk3_canFireOn(_self_, (org.imt.pssm.reactive.model.statemachines.Transition)_self,eventOccurrence);
    };
  ...
  private static void exitSource(final Transition _self, final EventOccurrence eventOccurrence) {
    ...
    if (_self instanceof org.imt.pssm.reactive.model.statemachines.Transition){
    	org.imt.pssm.reactive.interpreter.TransitionAspect._privk3_exitSource(_self_, (org.imt.pssm.reactive.model.statemachines.Transition)_self,eventOccurrence);
    };
  }
  ...
  private static void enterTarget(final Transition _self, final EventOccurrence eventOccurrence) {
    ...
    if (_self instanceof org.imt.pssm.reactive.model.statemachines.Transition){
    	org.imt.pssm.reactive.interpreter.TransitionAspect._privk3_enterTarget(_self_, (org.imt.pssm.reactive.model.statemachines.Transition)_self,eventOccurrence);
    };
  }
  ...
  private static State getContainingState(final Transition _self) {
    ...
    if (_self instanceof org.imt.pssm.reactive.model.statemachines.Transition){
    	result = org.imt.pssm.reactive.interpreter.TransitionAspect._privk3_getContainingState(_self_, (org.imt.pssm.reactive.model.statemachines.Transition)_self);
    };
  ...
  private static Region getRegion(final Transition _self, final EObject object) {
    ...
    if (_self instanceof org.imt.pssm.reactive.model.statemachines.Transition){
    	result = org.imt.pssm.reactive.interpreter.TransitionAspect._privk3_getRegion(_self_, (org.imt.pssm.reactive.model.statemachines.Transition)_self,object);
    };
  ...
  private static Region getLeastCommonAncestor(final Transition _self) {
    ...
    if (_self instanceof org.imt.pssm.reactive.model.statemachines.Transition){
    	result = org.imt.pssm.reactive.interpreter.TransitionAspect._privk3_getLeastCommonAncestor(_self_, (org.imt.pssm.reactive.model.statemachines.Transition)_self);
    };
    return (org.imt.pssm.reactive.model.statemachines.Region)result;
  }
  ...
  public static StateMachine getRootStateMachine(final Transition _self) {
    ...
    if (_self instanceof org.imt.pssm.reactive.model.statemachines.Transition){
    	result = org.imt.pssm.reactive.interpreter.TransitionAspect._privk3_getRootStateMachine(_self_, (org.imt.pssm.reactive.model.statemachines.Transition)_self);
    };
    return (org.imt.pssm.reactive.model.statemachines.StateMachine)result;
  }
  ...
  protected static boolean traversed(final Transition _self) {
    ...
    if (_self instanceof org.imt.pssm.reactive.model.statemachines.Transition){
    	result = org.imt.pssm.reactive.interpreter.TransitionAspect._privk3_traversed(_self_, (org.imt.pssm.reactive.model.statemachines.Transition)_self);
    };
    return (boolean)result;
  }
  ...
  protected static void traversed(final Transition _self, final boolean traversed) {
    ...
    if (_self instanceof org.imt.pssm.reactive.model.statemachines.Transition){
    	org.imt.pssm.reactive.interpreter.TransitionAspect._privk3_traversed(_self_, (org.imt.pssm.reactive.model.statemachines.Transition)_self,traversed);
    };
  }
  ...
  private static Region _leastCommonAncestor(final Transition _self) {
    ...
    if (_self instanceof org.imt.pssm.reactive.model.statemachines.Transition){
    	result = org.imt.pssm.reactive.interpreter.TransitionAspect._privk3__leastCommonAncestor(_self_, (org.imt.pssm.reactive.model.statemachines.Transition)_self);
    };
    return (org.imt.pssm.reactive.model.statemachines.Region)result;
  }
  ...
  private static void _leastCommonAncestor(final Transition _self, final Region _leastCommonAncestor) {
    ...
    if (_self instanceof org.imt.pssm.reactive.model.statemachines.Transition){
    	org.imt.pssm.reactive.interpreter.TransitionAspect._privk3__leastCommonAncestor(_self_, (org.imt.pssm.reactive.model.statemachines.Transition)_self,_leastCommonAncestor);
    };
  }
    	...
    	for (java.lang.reflect.Method m : _self.getClass().getMethods()) {
    		if (m.getName().equals("get_leastCommonAncestor") &&
    			m.getParameterTypes().length == 0) {
    				Object ret = m.invoke(_self);
    				if (ret != null) {
    					return (org.imt.pssm.reactive.model.statemachines.Region) ret;
    				} else {
    					return null;
    				}
    		}

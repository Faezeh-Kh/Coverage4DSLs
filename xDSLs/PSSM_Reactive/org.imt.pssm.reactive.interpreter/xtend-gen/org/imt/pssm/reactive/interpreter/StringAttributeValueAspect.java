...
public class StringAttributeValueAspect extends AttributeValueAspect {
  ...
  protected static String get_value(final StringAttributeValue _self) {
    final org.imt.pssm.reactive.interpreter.StringAttributeValueAspectStringAttributeValueAspectProperties _self_ = org.imt.pssm.reactive.interpreter.StringAttributeValueAspectStringAttributeValueAspectContext.getSelf(_self);
    Object result = null;
    ...
    if (_self instanceof org.imt.pssm.reactive.model.statemachines.StringAttributeValue){
    	result = org.imt.pssm.reactive.interpreter.StringAttributeValueAspect._privk3_get_value(_self_, (org.imt.pssm.reactive.model.statemachines.StringAttributeValue)_self);
    };
  ...
  protected static void set_value(final StringAttributeValue _self, final String value) {
    ...
    if (_self instanceof org.imt.pssm.reactive.model.statemachines.StringAttributeValue){
    	org.imt.pssm.reactive.interpreter.StringAttributeValueAspect._privk3_set_value(_self_, (org.imt.pssm.reactive.model.statemachines.StringAttributeValue)_self,value);
    };
  }
  ...
  protected static Attribute get_attribute(final StringAttributeValue _self) {
    ...
    if (_self instanceof org.imt.pssm.reactive.model.statemachines.StringAttributeValue){
    	result = org.imt.pssm.reactive.interpreter.StringAttributeValueAspect._privk3_get_attribute(_self_, (org.imt.pssm.reactive.model.statemachines.StringAttributeValue)_self);
    };
  ...
  protected static String getString(final StringAttributeValue _self) {
    ...
    if (_self instanceof org.imt.pssm.reactive.model.statemachines.StringAttributeValue){
    	result = org.imt.pssm.reactive.interpreter.StringAttributeValueAspect._privk3_getString(_self_, (org.imt.pssm.reactive.model.statemachines.StringAttributeValue)_self);
    };
    return (java.lang.String)result;
  }

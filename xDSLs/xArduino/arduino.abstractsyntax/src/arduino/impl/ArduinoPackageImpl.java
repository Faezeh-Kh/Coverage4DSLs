...
import arduino.BinaryBooleanOperatorKind;
...
import arduino.UnaryIntegerOperatorKind;
...
public class ArduinoPackageImpl extends EPackageImpl implements ArduinoPackage {
	 ...
	 * @generated
	 */
	public EAttribute getWaitFor_Mode() {
		return (EAttribute)waitForEClass.getEStructuralFeatures().get(1);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(moduleEClass, arduino.Module.class, "Module", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEAttribute(getLED_Color(), this.getColor(), "color", "blue", 1, 1, arduino.LED.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(changeTypeEEnum, ChangeType.RISING);
		addEEnumLiteral(changeTypeEEnum, ChangeType.FALLING);
		addEEnumLiteral(changeTypeEEnum, ChangeType.CHANGE);

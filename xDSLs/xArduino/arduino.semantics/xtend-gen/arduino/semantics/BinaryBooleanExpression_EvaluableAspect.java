...
public class BinaryBooleanExpression_EvaluableAspect extends Expression_EvaluableAspect {
  ...
  public static Object evaluate(final BinaryBooleanExpression _self) {
    final arduino.semantics.BinaryBooleanExpression_EvaluableAspectBinaryBooleanExpressionAspectProperties _self_ = arduino.semantics.BinaryBooleanExpression_EvaluableAspectBinaryBooleanExpressionAspectContext.getSelf(_self);
    Object result = null;
    // #DispatchPointCut_before# Object evaluate()
    if (_self instanceof arduino.BinaryBooleanExpression){
    	result = arduino.semantics.BinaryBooleanExpression_EvaluableAspect._privk3_evaluate(_self_, (arduino.BinaryBooleanExpression)_self);
    };

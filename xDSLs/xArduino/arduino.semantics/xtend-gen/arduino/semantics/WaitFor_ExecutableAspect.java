...
public class WaitFor_ExecutableAspect extends Utilities_ExecutableAspect {
  ...
  public static void execute(final WaitFor _self) {
    final arduino.semantics.WaitFor_ExecutableAspectWaitForAspectProperties _self_ = arduino.semantics.WaitFor_ExecutableAspectWaitForAspectContext.getSelf(_self);
    // #DispatchPointCut_before# void execute()
    if (_self instanceof arduino.WaitFor){
    	fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand command = new fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand() {
    		@Override
    		public void execute() {
    			arduino.semantics.WaitFor_ExecutableAspect._privk3_execute(_self_, (arduino.WaitFor)_self);
    		}
    	};
  ...
  private static boolean isValidated(final WaitFor _self) {
    ...
    if (_self instanceof arduino.WaitFor){
    	result = arduino.semantics.WaitFor_ExecutableAspect._privk3_isValidated(_self_, (arduino.WaitFor)_self);
    };
  ...
  private static void loop(final WaitFor _self) {
    ...
    if (_self instanceof arduino.WaitFor){
    	arduino.semantics.WaitFor_ExecutableAspect._privk3_loop(_self_, (arduino.WaitFor)_self);
    };
  }
  ...
  public static void setActivated(final WaitFor _self) {
    ...
    if (_self instanceof arduino.WaitFor){
    	arduino.semantics.WaitFor_ExecutableAspect._privk3_setActivated(_self_, (arduino.WaitFor)_self);
    };
  }
  ...
  private static boolean waiting(final WaitFor _self) {
    ...
    if (_self instanceof arduino.WaitFor){
    	result = arduino.semantics.WaitFor_ExecutableAspect._privk3_waiting(_self_, (arduino.WaitFor)_self);
    };
    return (boolean)result;
  }
  ...
  private static void waiting(final WaitFor _self, final boolean waiting) {
    ...
    if (_self instanceof arduino.WaitFor){
    	arduino.semantics.WaitFor_ExecutableAspect._privk3_waiting(_self_, (arduino.WaitFor)_self,waiting);
    };
  }
  ...
  private static boolean moduleActivated(final WaitFor _self) {
    ...
    if (_self instanceof arduino.WaitFor){
    	result = arduino.semantics.WaitFor_ExecutableAspect._privk3_moduleActivated(_self_, (arduino.WaitFor)_self);
    };
    return (boolean)result;
  }
  ...
  private static void moduleActivated(final WaitFor _self, final boolean moduleActivated) {
    ...
    if (_self instanceof arduino.WaitFor){
    	arduino.semantics.WaitFor_ExecutableAspect._privk3_moduleActivated(_self_, (arduino.WaitFor)_self,moduleActivated);
    };
  }
  ...
  private static int value(final WaitFor _self) {
    ...
    if (_self instanceof arduino.WaitFor){
    	result = arduino.semantics.WaitFor_ExecutableAspect._privk3_value(_self_, (arduino.WaitFor)_self);
    };
    return (int)result;
  }
  ...
  private static void value(final WaitFor _self, final int value) {
    ...
    if (_self instanceof arduino.WaitFor){
    	arduino.semantics.WaitFor_ExecutableAspect._privk3_value(_self_, (arduino.WaitFor)_self,value);
    };
  }

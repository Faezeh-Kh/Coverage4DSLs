...
public class Constant_EvaluableAspect extends Expression_EvaluableAspect {
  ...
  public static Object evaluate(final Constant _self) {
    final arduino.semantics.Constant_EvaluableAspectConstantAspectProperties _self_ = arduino.semantics.Constant_EvaluableAspectConstantAspectContext.getSelf(_self);
    Object result = null;
    // #DispatchPointCut_before# Object evaluate()
    if (_self instanceof arduino.Constant){
    	result = arduino.semantics.Constant_EvaluableAspect._privk3_evaluate(_self_, (arduino.Constant)_self);
    };

 ...
 * @generated
 */
public class ItemGeneratorImpl extends MinimalEObjectImpl.Container implements ItemGenerator {
	/**
	...
	public void setFrequency(int newFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TllPackage.ITEM_GENERATOR__FREQUENCY, oldFrequency, frequency));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TllPackage.ITEM_GENERATOR__FREQUENCY:
				return getFrequency();
		}

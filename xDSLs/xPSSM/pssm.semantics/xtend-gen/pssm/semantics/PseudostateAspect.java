...
public class PseudostateAspect extends VertexAspect {
  ...
  protected static boolean isEnterable(final Pseudostate _self, final Transition enteringTransition) {
    ...
    if (_self instanceof statemachines.Pseudostate){
    	result = pssm.semantics.PseudostateAspect._privk3_isEnterable(_self_, (statemachines.Pseudostate)_self,enteringTransition);
    };
  ...
  protected static boolean isExitable(final Pseudostate _self, final Transition exitingTransition) {
    ...
    if (_self instanceof statemachines.Pseudostate){
    	result = pssm.semantics.PseudostateAspect._privk3_isExitable(_self_, (statemachines.Pseudostate)_self,exitingTransition);
    };
    return (boolean)result;
  }
  ...
  protected static boolean isActive(final Pseudostate _self) {
    ...
    if (_self instanceof statemachines.Pseudostate){
    	result = pssm.semantics.PseudostateAspect._privk3_isActive(_self_, (statemachines.Pseudostate)_self);
    };
    return (boolean)result;
  }
  ...
  protected static Region getContainingRegion(final Pseudostate _self) {
    ...
    if (_self instanceof statemachines.Pseudostate){
    	result = pssm.semantics.PseudostateAspect._privk3_getContainingRegion(_self_, (statemachines.Pseudostate)_self);
    };
  ...
  protected static State getParentState(final Pseudostate _self) {
    ...
    if (_self instanceof statemachines.Pseudostate){
    	result = pssm.semantics.PseudostateAspect._privk3_getParentState(_self_, (statemachines.Pseudostate)_self);
    };

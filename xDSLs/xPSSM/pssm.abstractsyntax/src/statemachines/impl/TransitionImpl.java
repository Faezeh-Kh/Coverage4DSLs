 ...
 *   <li>{@link statemachines.impl.TransitionImpl#getTriggers <em>Triggers</em>}</li>
 *   <li>{@link statemachines.impl.TransitionImpl#getContainer <em>Container</em>}</li>
 *   <li>{@link statemachines.impl.TransitionImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link statemachines.impl.TransitionImpl#getEffect <em>Effect</em>}</li>
 *   <li>{@link statemachines.impl.TransitionImpl#getConstraint <em>Constraint</em>}</li>
 * </ul>
 *
 * @generated
 */

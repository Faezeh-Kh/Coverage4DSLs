...
public class InequalityAspect extends ExpressionAspect {
  ...
  public static Value evaluateExpression(final Inequality _self, final State state) {
    final org.imt.xminijava.interpreter.InequalityAspectInequalityAspectProperties _self_ = org.imt.xminijava.interpreter.InequalityAspectInequalityAspectContext.getSelf(_self);
    Object result = null;
    // #DispatchPointCut_before# Value evaluateExpression(State)
    if (_self instanceof org.imt.minijava.xminiJava.Inequality){
    	result = org.imt.xminijava.interpreter.InequalityAspect._privk3_evaluateExpression(_self_, (org.imt.minijava.xminiJava.Inequality)_self,state);
    };

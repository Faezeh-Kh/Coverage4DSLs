...
public class SuperiorOrEqualAspect extends ExpressionAspect {
  ...
  public static Value evaluateExpression(final SuperiorOrEqual _self, final State state) {
    final org.imt.xminijava.interpreter.SuperiorOrEqualAspectSuperiorOrEqualAspectProperties _self_ = org.imt.xminijava.interpreter.SuperiorOrEqualAspectSuperiorOrEqualAspectContext.getSelf(_self);
    Object result = null;
    // #DispatchPointCut_before# Value evaluateExpression(State)
    if (_self instanceof org.imt.minijava.xminiJava.SuperiorOrEqual){
    	result = org.imt.xminijava.interpreter.SuperiorOrEqualAspect._privk3_evaluateExpression(_self_, (org.imt.minijava.xminiJava.SuperiorOrEqual)_self,state);
    };

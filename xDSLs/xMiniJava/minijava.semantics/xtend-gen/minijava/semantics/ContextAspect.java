...
public class ContextAspect {
  public static Context createChildContext(final Context _self) {
    final minijava.semantics.ContextAspectContextAspectProperties _self_ = minijava.semantics.ContextAspectContextAspectContext.getSelf(_self);
    Object result = null;
    // #DispatchPointCut_before# Context createChildContext()
    if (_self instanceof xminiJava.Context){
    	result = minijava.semantics.ContextAspect._privk3_createChildContext(_self_, (xminiJava.Context)_self);
    };
  ...
  public static SymbolBinding findBinding(final Context _self, final Symbol symbol) {
    ...
    if (_self instanceof xminiJava.Context){
    	result = minijava.semantics.ContextAspect._privk3_findBinding(_self_, (xminiJava.Context)_self,symbol);
    };
    return (xminiJava.SymbolBinding)result;
  }
  ...
  public static Context findCurrentContext(final Context _self) {
    ...
    if (_self instanceof xminiJava.Context){
    	result = minijava.semantics.ContextAspect._privk3_findCurrentContext(_self_, (xminiJava.Context)_self);
    };
    return (xminiJava.Context)result;
  }
  ...
  private static Map<Symbol, SymbolBinding> cache(final Context _self) {
    ...
    if (_self instanceof xminiJava.Context){
    	result = minijava.semantics.ContextAspect._privk3_cache(_self_, (xminiJava.Context)_self);
    };
    return (java.util.Map<xminiJava.Symbol, xminiJava.SymbolBinding>)result;
  }
  ...
  protected static Context _privk3_createChildContext(final ContextAspectContextAspectProperties _self_, final Context _self) {
    ...
    final Procedure1<Context> _function = new Procedure1<Context>() {
      public void apply(final Context it) {
  ...
  protected static SymbolBinding _privk3_findBinding(final ContextAspectContextAspectProperties _self_, final Context _self, final Symbol symbol) {
    try {
      ...
      if (_not) {
        final Function1<SymbolBinding, Boolean> _function = new Function1<SymbolBinding, Boolean>() {
          public Boolean apply(final SymbolBinding it) {

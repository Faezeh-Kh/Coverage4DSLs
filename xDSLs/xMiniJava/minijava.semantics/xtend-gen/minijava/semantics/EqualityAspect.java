...
public class EqualityAspect extends ExpressionAspect {
  ...
  public static Value evaluateExpression(final Equality _self, final State state) {
    final minijava.semantics.EqualityAspectEqualityAspectProperties _self_ = minijava.semantics.EqualityAspectEqualityAspectContext.getSelf(_self);
    Object result = null;
    // #DispatchPointCut_before# Value evaluateExpression(State)
    if (_self instanceof xminiJava.Equality){
    	result = minijava.semantics.EqualityAspect._privk3_evaluateExpression(_self_, (xminiJava.Equality)_self,state);
    };

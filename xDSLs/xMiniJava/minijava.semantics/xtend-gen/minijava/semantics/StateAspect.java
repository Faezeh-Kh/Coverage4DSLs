...
public class StateAspect {
  public static Frame findCurrentFrame(final State _self) {
    final minijava.semantics.StateAspectStateAspectProperties _self_ = minijava.semantics.StateAspectStateAspectContext.getSelf(_self);
    Object result = null;
    // #DispatchPointCut_before# Frame findCurrentFrame()
    if (_self instanceof xminiJava.State){
    	result = minijava.semantics.StateAspect._privk3_findCurrentFrame(_self_, (xminiJava.State)_self);
    };
  ...
  public static Context findCurrentContext(final State _self) {
    ...
    if (_self instanceof xminiJava.State){
    	result = minijava.semantics.StateAspect._privk3_findCurrentContext(_self_, (xminiJava.State)_self);
    };
  ...
  public static void println(final State _self, final String string) {
    ...
    if (_self instanceof xminiJava.State){
    	minijava.semantics.StateAspect._privk3_println(_self_, (xminiJava.State)_self,string);
    };
  }
  ...
  public static void pushNewContext(final State _self) {
    ...
    if (_self instanceof xminiJava.State){
    	minijava.semantics.StateAspect._privk3_pushNewContext(_self_, (xminiJava.State)_self);
    };
  }
  ...
  public static void popCurrentContext(final State _self) {
    ...
    if (_self instanceof xminiJava.State){
    	minijava.semantics.StateAspect._privk3_popCurrentContext(_self_, (xminiJava.State)_self);
    };
  }
  ...
  public static void pushNewFrame(final State _self, final ObjectInstance receiver, final Call c, final Context newContext) {
    ...
    if (_self instanceof xminiJava.State){
    	minijava.semantics.StateAspect._privk3_pushNewFrame(_self_, (xminiJava.State)_self,receiver,c,newContext);
    };
  }
  ...
  public static void popCurrentFrame(final State _self) {
    ...
    if (_self instanceof xminiJava.State){
    	minijava.semantics.StateAspect._privk3_popCurrentFrame(_self_, (xminiJava.State)_self);
    };
  }
  ...
  private static Frame frameCache(final State _self) {
    ...
    if (_self instanceof xminiJava.State){
    	result = minijava.semantics.StateAspect._privk3_frameCache(_self_, (xminiJava.State)_self);
    };
    return (xminiJava.Frame)result;
  }
  ...
  private static void frameCache(final State _self, final Frame frameCache) {
    ...
    if (_self instanceof xminiJava.State){
    	minijava.semantics.StateAspect._privk3_frameCache(_self_, (xminiJava.State)_self,frameCache);
    };
  }
  ...
  private static Context contextCache(final State _self) {
    ...
    if (_self instanceof xminiJava.State){
    	result = minijava.semantics.StateAspect._privk3_contextCache(_self_, (xminiJava.State)_self);
    };
    return (xminiJava.Context)result;
  }
  ...
  private static void contextCache(final State _self, final Context contextCache) {
    ...
    if (_self instanceof xminiJava.State){
    	minijava.semantics.StateAspect._privk3_contextCache(_self_, (xminiJava.State)_self,contextCache);
    };
  }

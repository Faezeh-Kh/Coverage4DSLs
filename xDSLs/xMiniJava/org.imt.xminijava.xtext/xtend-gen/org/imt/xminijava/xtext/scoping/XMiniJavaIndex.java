...
public class XMiniJavaIndex {
  ...
  public Iterable<IEObjectDescription> getVisibleClassesDescriptions(final EObject o) {
    return this.getVisibleEObjectDescriptions(o, XminiJavaPackage.eINSTANCE.getClass_());
  }
  ...
  public Iterable<IEObjectDescription> getExportedClassesEObjectDescriptions(final EObject o) {
    return this.getResourceDescription(o).getExportedObjectsByType(XminiJavaPackage.eINSTANCE.getClass_());
  }
}

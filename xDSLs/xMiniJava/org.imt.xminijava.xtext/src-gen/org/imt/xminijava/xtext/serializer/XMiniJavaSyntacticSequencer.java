...
public class XMiniJavaSyntacticSequencer extends AbstractSyntacticSequencer {

	protected XMiniJavaGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (XMiniJavaGrammarAccess) access;

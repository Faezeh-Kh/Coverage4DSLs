 ...
 * </p>
 * <ul>
 *   <li>{@link xminiJava.impl.OutputStreamImpl#getStream <em>Stream</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutputStreamImpl extends MinimalEObjectImpl.Container implements OutputStream {
	...
	protected EClass eStaticClass() {
		return XminiJavaPackage.Literals.OUTPUT_STREAM;
	}
	...
	public EList<String> getStream() {
		if (stream == null) {
			stream = new EDataTypeEList<String>(String.class, this, XminiJavaPackage.OUTPUT_STREAM__STREAM);
		}
		return stream;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XminiJavaPackage.OUTPUT_STREAM__STREAM:
				return getStream();
		}

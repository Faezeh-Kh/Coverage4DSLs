 ...
 * </p>
 * <ul>
 *   <li>{@link xminiJava.impl.ObjectRefValueImpl#getInstance <em>Instance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ObjectRefValueImpl extends ValueImpl implements ObjectRefValue {
	...
	protected EClass eStaticClass() {
		return XminiJavaPackage.Literals.OBJECT_REF_VALUE;
	}
		...
		if (instance != null && instance.eIsProxy()) {
			...
			if (instance != oldInstance) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XminiJavaPackage.OBJECT_REF_VALUE__INSTANCE, oldInstance, instance));
			}
		}
		return instance;
	}
	...
	public void setInstance(ObjectInstance newInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XminiJavaPackage.OBJECT_REF_VALUE__INSTANCE, oldInstance, instance));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XminiJavaPackage.OBJECT_REF_VALUE__INSTANCE:

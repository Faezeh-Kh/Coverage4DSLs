 ...
 * </p>
 * <ul>
 *   <li>{@link xminiJava.impl.SymbolRefImpl#getSymbol <em>Symbol</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SymbolRefImpl extends ExpressionImpl implements SymbolRef {
	...
	protected EClass eStaticClass() {
		return XminiJavaPackage.Literals.SYMBOL_REF;
	}
		...
		if (symbol != null && symbol.eIsProxy()) {
			...
			if (symbol != oldSymbol) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XminiJavaPackage.SYMBOL_REF__SYMBOL, oldSymbol, symbol));
			}
		}
		return symbol;
	}
	...
	public void setSymbol(Symbol newSymbol) {
		...
		symbol = newSymbol;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XminiJavaPackage.SYMBOL_REF__SYMBOL, oldSymbol, symbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XminiJavaPackage.SYMBOL_REF__SYMBOL:

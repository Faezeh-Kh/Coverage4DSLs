 ...
 * @generated
 */
public class XminiJavaPackageImpl extends EPackageImpl implements XminiJavaPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see xminiJava.XminiJavaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private XminiJavaPackageImpl() {
		super(eNS_URI, XminiJavaFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link XminiJavaPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static XminiJavaPackage init() {
		if (isInited) return (XminiJavaPackage)EPackage.Registry.INSTANCE.getEPackage(XminiJavaPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredXminiJavaPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		XminiJavaPackageImpl theXminiJavaPackage = registeredXminiJavaPackage instanceof XminiJavaPackageImpl ? (XminiJavaPackageImpl)registeredXminiJavaPackage : new XminiJavaPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theXminiJavaPackage.createPackageContents();

		// Initialize created meta-data
		theXminiJavaPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theXminiJavaPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(XminiJavaPackage.eNS_URI, theXminiJavaPackage);
		return theXminiJavaPackage;
	}
	 ...
	 * @generated
	 */
	public XminiJavaFactory getXminiJavaFactory() {
		return (XminiJavaFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEClass(classEClass, xminiJava.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getClass_Abstract(), ecorePackage.getEBoolean(), "abstract", null, 0, 1, xminiJava.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_SuperClass(), this.getClass_(), null, "superClass", null, 0, 1, xminiJava.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

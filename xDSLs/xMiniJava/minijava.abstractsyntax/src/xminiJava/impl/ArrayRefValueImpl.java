 ...
 * </p>
 * <ul>
 *   <li>{@link xminiJava.impl.ArrayRefValueImpl#getInstance <em>Instance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayRefValueImpl extends ValueImpl implements ArrayRefValue {
	...
	protected EClass eStaticClass() {
		return XminiJavaPackage.Literals.ARRAY_REF_VALUE;
	}
		...
		if (instance != null && instance.eIsProxy()) {
			...
			if (instance != oldInstance) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XminiJavaPackage.ARRAY_REF_VALUE__INSTANCE, oldInstance, instance));
			}
		}
		return instance;
	}
	...
	public void setInstance(ArrayInstance newInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XminiJavaPackage.ARRAY_REF_VALUE__INSTANCE, oldInstance, instance));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XminiJavaPackage.ARRAY_REF_VALUE__INSTANCE:

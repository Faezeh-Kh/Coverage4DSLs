 ...
 * </p>
 * <ul>
 *   <li>{@link xminiJava.impl.ObjectInstanceImpl#getFieldbindings <em>Fieldbindings</em>}</li>
 *   <li>{@link xminiJava.impl.ObjectInstanceImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ObjectInstanceImpl extends MinimalEObjectImpl.Container implements ObjectInstance {
	 ...
	 * @ordered
	 */
	protected xminiJava.Class type;
	 ...
	 * @generated
	 */
	public xminiJava.Class getType() {
		if (type != null && type.eIsProxy()) {
			InternalEObject oldType = (InternalEObject)type;
			type = (xminiJava.Class)eResolveProxy(oldType);
			if (type != oldType) {
	 ...
	 * @generated
	 */
	public xminiJava.Class basicGetType() {
		return type;
	}
	 ...
	 * @generated
	 */
	public void setType(xminiJava.Class newType) {
		xminiJava.Class oldType = type;
		type = newType;
		if (eNotificationRequired())
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case XminiJavaPackage.OBJECT_INSTANCE__FIELDBINDINGS:
				...
				return;
			case XminiJavaPackage.OBJECT_INSTANCE__TYPE:
				setType((xminiJava.Class)newValue);
				return;
		}

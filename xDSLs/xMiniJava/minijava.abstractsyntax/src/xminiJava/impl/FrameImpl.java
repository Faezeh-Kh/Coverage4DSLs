 ...
 * </p>
 * <ul>
 *   <li>{@link xminiJava.impl.FrameImpl#getCall <em>Call</em>}</li>
 *   <li>{@link xminiJava.impl.FrameImpl#getInstance <em>Instance</em>}</li>
 *   <li>{@link xminiJava.impl.FrameImpl#getChildFrame <em>Child Frame</em>}</li>
 *   <li>{@link xminiJava.impl.FrameImpl#getParentFrame <em>Parent Frame</em>}</li>
 *   <li>{@link xminiJava.impl.FrameImpl#getRootContext <em>Root Context</em>}</li>
 *   <li>{@link xminiJava.impl.FrameImpl#getReturnValue <em>Return Value</em>}</li>
 * </ul>
 *
 * @generated
 */

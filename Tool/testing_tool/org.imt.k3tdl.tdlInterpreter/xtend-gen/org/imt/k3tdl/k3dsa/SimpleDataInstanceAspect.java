...
public class SimpleDataInstanceAspect extends DataInstanceAspect {
  ...
  public static EObject getMatchedMUTElement(final SimpleDataInstance _self, final ArrayList<EObject> rootElement, final Resource MUTResource, final boolean isAssertion, final String DSLPath) {
  ...
  private static EObject super_getMatchedMUTElement(final SimpleDataInstance _self, final ArrayList<EObject> rootElement, final Resource MUTResource, final boolean isAssertion, final String DSLPath) {
  ...
  protected static EObject _privk3_getMatchedMUTElement(final SimpleDataInstanceAspectSimpleDataInstanceAspectProperties _self_, final SimpleDataInstance _self, final ArrayList<EObject> rootElement, final Resource MUTResource, final boolean isAssertion, final String DSLPath) {

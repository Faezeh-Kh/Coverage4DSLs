...
public class COVParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, COVGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getConditionalIgnoreAccess().getGroup_4(), "rule__ConditionalIgnore__Group_4__0");
			...
			builder.put(grammarAccess.getBranchSpecificationAccess().getGroup_8(), "rule__BranchSpecification__Group_8__0");
			...
			builder.put(grammarAccess.getIgnoreAccess().getDescriptionAssignment_5_2(), "rule__Ignore__DescriptionAssignment_5_2");
			...
			builder.put(grammarAccess.getConditionalIgnoreAccess().getDescriptionAssignment_4_2(), "rule__ConditionalIgnore__DescriptionAssignment_4_2");
			...
			builder.put(grammarAccess.getCoverageOfReferencedAccess().getDescriptionAssignment_3_2(), "rule__CoverageOfReferenced__DescriptionAssignment_3_2");
			...
			builder.put(grammarAccess.getCoverageByContentAccess().getDescriptionAssignment_5_2(), "rule__CoverageByContent__DescriptionAssignment_5_2");
			builder.put(grammarAccess.getBranchSpecificationAccess().getDescriptionAssignment_4(), "rule__BranchSpecification__DescriptionAssignment_4");
			builder.put(grammarAccess.getBranchSpecificationAccess().getConditionAssignment_6(), "rule__BranchSpecification__ConditionAssignment_6");
			builder.put(grammarAccess.getBranchSpecificationAccess().getBranchesAssignment_7(), "rule__BranchSpecification__BranchesAssignment_7");
			builder.put(grammarAccess.getBranchSpecificationAccess().getBranchesAssignment_8_1(), "rule__BranchSpecification__BranchesAssignment_8_1");

 ...
 * </p>
 * <ul>
 *   <li>{@link DSLSpecificCoverage.impl.BinaryConditionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BinaryConditionImpl extends ConditionImpl implements BinaryCondition {
	...
	protected EClass eStaticClass() {
		return DSLSpecificCoveragePackage.Literals.BINARY_CONDITION;
	}
	...
	public void setOperator(BinaryOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DSLSpecificCoveragePackage.BINARY_CONDITION__OPERATOR, oldOperator, operator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DSLSpecificCoveragePackage.BINARY_CONDITION__OPERATOR:
				return getOperator();
		}

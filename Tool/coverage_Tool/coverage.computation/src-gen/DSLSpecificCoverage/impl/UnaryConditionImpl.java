 ...
 * </p>
 * <ul>
 *   <li>{@link DSLSpecificCoverage.impl.UnaryConditionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnaryConditionImpl extends ConditionImpl implements UnaryCondition {
	...
	protected EClass eStaticClass() {
		return DSLSpecificCoveragePackage.Literals.UNARY_CONDITION;
	}
	...
	public void setOperator(UnaryOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DSLSpecificCoveragePackage.UNARY_CONDITION__OPERATOR, oldOperator, operator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DSLSpecificCoveragePackage.UNARY_CONDITION__OPERATOR:
				return getOperator();
		}

 ...
 * </p>
 * <ul>
 *   <li>{@link DSLSpecificCoverage.impl.RuleImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link DSLSpecificCoverage.impl.RuleImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class RuleImpl extends MinimalEObjectImpl.Container implements Rule {
	...
	protected EClass eStaticClass() {
		return DSLSpecificCoveragePackage.Literals.RULE;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DSLSpecificCoveragePackage.RULE__DESCRIPTION, oldDescription, description));
	}
